...
class Settings:
    ...
    async def add_commands(self, force: typing.Optional[bool] = False) -> None:
        ...
        if self.group != Config.GLOBAL:
            _kwargs = self.rpc_callback_settings.__dashboard_decorator_params__[1]
            _kwargs["context_ids"] = ["guild_id", f"{self.group.lower()}_id"]
            self.rpc_callback_settings.__dashboard_decorator_params__ = (self.rpc_callback_settings.__dashboard_decorator_params__[0], _kwargs)
